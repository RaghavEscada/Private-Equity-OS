-- ============================================================================
-- DIRECT IMPORT: CSV → deals table (one step, no staging table)
-- ============================================================================
-- 
-- HOW TO USE:
-- 1. Go to Supabase Table Editor
-- 2. Create a NEW table called "temp_csv_import" (or any name you want)
-- 3. Import your CSV into that table (Supabase will auto-create columns)
-- 4. Run this script (it will map columns and delete temp table automatically)
-- ============================================================================

-- First, let's see what table you created (replace 'temp_csv_import' with your table name)
-- Run this to see your temp table columns:
SELECT column_name 
FROM information_schema.columns
WHERE table_name = 'temp_csv_import'  -- CHANGE THIS to your temp table name
  AND table_schema = 'public';

-- ============================================================================
-- MAIN IMPORT (replace 'temp_csv_import' with your actual temp table name)
-- ============================================================================
...
FROM temp_csv_import  -- CHANGE THIS to your temp table name
WHERE "Company name" IS NOT NULL AND TRIM("Company name") != '';

-- ============================================================================
-- DELETE TEMP TABLE (cleanup)
-- ============================================================================
DROP TABLE IF EXISTS temp_csv_import;  -- CHANGE THIS to your temp table name
