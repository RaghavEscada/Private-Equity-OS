...
import { DealTable } from \"@/components/ui/DealChat\";
import { Button } from \"@rmrf/services/peos/client/components/ui/button\";
        ...
        <div className=\"container mx-auto px  -4 py-3 flex items-center justify-between gap-4\">
          ...
          <div className=\"flex items-center gap-3\">
            ...
            <Button
              ...
              asChild
            >
              <Link href=\"/chat\">Open Deal Lab</Link>
            </Button>
          </div>
        </div>
      </header>
        ...
        <div className=\"container mx-auto px-4 py-6\">
          {loading ? (
            ...
            <DealTable
              deals={filteredDeals}
              onDealClick={(deal) => {
                window.open(`/chat?dealId=${deal.id}`, \"_blank\");
              }}
            />
          )}
        </div>
